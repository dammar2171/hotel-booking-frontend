...
const dataHero = {
  ...
  description:
    "Browse our collection of comfortable and luxurious rooms, thoughtfully designed to suit every traveler. Whether you're here for business or leisure, we have the perfect room for you.",
};
function RoomPage() {
  ...
  const filtered = rooms.filter((room) => {
    ...
    const matchPrice =
      ...
      (priceRange === 'Medium' && room.price > 5000 && room.price <= 10000) ||
      (priceRange === 'High' && room.price > 10000 && room.price <= 50000) ||
      (priceRange === 'ultraHigh' && room.price > 50000);
